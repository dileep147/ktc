...
class ProjectConfig {
    ...
    public static $project_name = " KTC Admin Panel ";
    public static $address = " KTC Admin Panel ";
    public static $tel = " Phone: 031 12 34 567 / 077 12 34 567 ";
    public static $address_arr = array("KTC Admin Panel", "Address 1", "Address 2", "Address 3", "Address 4");
    public static $tel_arr = array(" 033 22 70 922 ", " 077 30 02 600 ");
    public static $address_html = "<strong> KTC Admin Panel </strong> , <br/> Address,<br/>Address,<br/>Address. ";
