...
if (!(isset($_POST["id"]) && $role = PackageCategory::find_by_id($_POST["id"]))) {
    $role = new PackageCategory();
}
?>
    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 style="font-weight:800;">Package Category</h3>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title" style="font-weight:700;"><?php echo (empty($role->id)) ? 'Add' : 'Edit'; ?> Package Category</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formRole" action="proccess/package_category_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="modal-footer col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" col-md-4 col-sm-4 col-xs-12">
                                        <a href="package_category.php"><button type="button" name="reset" class="btn btn-block btn-primary"><i class="fa fa-history"></i> Reset</button></a>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="x_content">
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                $total_records = PackageCategory::row_count();
                                $pagination = new Pagination($total_records);
                                $objects = PackageCategory::find_all_by_limit_offset($pagination->records_per_page, $pagination->offset());
                                ...
                                foreach ($objects as $role_data) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="package_category.php" method="post" style="float: left;">
