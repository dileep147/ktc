...
if (isset($_POST["id"]) && $role = ServiceCategory::find_by_id($_POST["id"])) {
    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3 style="font-weight:800;">Service Category</h3>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="title" style="font-weight:700;"><?php echo (empty($role->id)) ? 'Add' : 'Edit'; ?> Service Category</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form id="formRole" action="proccess/service_category_process.php" method="post" class="form-horizontal form-label-left" >
                            ...
                            <tbody>
                                ...
                                foreach ($objects as $role_data) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="service_category.php" method="post" style="float: left;">
