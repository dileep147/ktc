                        ...
                        <form id="formRole" action="proccess/customer_process.php" method="post" class="form-horizontal form-label-left" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Full Name" id="txtName" name="full_name" value="<?php echo$customer->full_name; ?>" required="">
                                </div>

                                 <div class="form-group">
                                    <label>Mobile Number</label>
                                    <input type="text" class="form-control" placeholder="Mobile Number" id="txtName" name="mobile" value="<?php echo$customer->mobile; ?>" required="">
                                </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" placeholder="Join Date" id="txtName" name="join_date" value="<?php echo$customer->join_date; ?>" required="">
                                </div>
